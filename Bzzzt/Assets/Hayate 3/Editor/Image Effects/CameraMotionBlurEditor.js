...
{	
  ...
  var previewT : SerializedProperty;
  ...
  //var dynamicLayers : SerializedProperty;
    ...
    previewT = serObj.FindProperty ("preview");
  ...
  function OnInspectorGUI () {         
    ...
    EditorGUILayout.PropertyField (this.previewT, new GUIContent("Preview"));
    if (this.previewT.boolValue)
